...
if __name__ == "__main__":
    mode = "test"
    check_point_path = '/home/kathy/projects/project_guo/test_edba/logs/logger_train2/version_6/checkpoints/epoch=215-step=13176.ckpt'
    ...
    if mode == "train":
        ...
        trainer = pl.Trainer(accelerator="gpu", devices=[0], precision=16, max_epochs=MAX_EPOCHS, logger=logger)
