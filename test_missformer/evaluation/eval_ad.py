...
while True:
    ...
    if not os.path.exists('./output1/' + save_context):
        os.mkdir('./output1/' + save_context)
    # pred
    ...
    plt.savefig("./output1/" + save_context + "/pred.png", transparent=True, bbox_inches='tight')
    ...
    axes.set_xticks([])
    axes.set_yticks([])
    plt.savefig("./output1/" + save_context + "/true.png", transparent=True, bbox_inches='tight')
