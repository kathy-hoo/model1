...
import os 
from model.vit_seg_modeling  import VisionTransformer as  Model
import random
...
import time 
from model.vit_seg_configs import get_b16_config as get_config
...
if __name__ == "__main__":
    mode = "test"
    check_point_path = '/home/kathy/projects/project_guo/test_transBts/logs/train_a/version_1/checkpoints/epoch=175-step=13200.ckpt'
    ...
    train_loader, val_laoder = get_dataloader(batch_size=8)
    if mode == "train":
        info = '''仅CE loss '''
        ...
        trainer = pl.Trainer(accelerator="gpu", devices=[7], precision=16, max_epochs=MAX_EPOCHS, logger=logger)
        ...
        model = TrainModel.load_from_checkpoint(check_point_path)
