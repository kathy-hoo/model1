...
model = TrainModel.load_from_checkpoint(
    "/home/kathy/projects/project_guo/test_transBts/logs/logger_train2/temp/version_4/checkpoints/epoch=299-step=18300.ckpt", 
    map_location=device
)
...
axes.set_xticks([])
axes.set_yticks([])
plt.savefig(f"./output1/pred32_{figure_name}", transparent=True, bbox_inches='tight')
