...
while True:
    ...
    if not os.path.exists(f'/home/kathy/projects/project_guo/test_{currrent_proj}/evaluation/output/' + save_context):
        os.mkdir(f'/home/kathy/projects/project_guo/test_{currrent_proj}/evaluation/output/' + save_context)
    # pred
    ...
    plt.savefig(f"/home/kathy/projects/project_guo/test_{currrent_proj}/evaluation/output/" + save_context + "/pred.png", transparent=True, bbox_inches='tight')
    ...
    axes.set_xticks([])
    axes.set_yticks([])
    plt.savefig(f"/home/kathy/projects/project_guo/test_{currrent_proj}/evaluation/output/" + save_context + "/true.png", transparent=True, bbox_inches='tight')
